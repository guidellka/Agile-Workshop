...
player 2 ชนะ เเนวตั้งซ้ายสุด
    เปิดหน้าเว็บเกมส์
    Player 1 คลิกตำแหน่งเเถวที่1คอลัมน์3
    Player 2 คลิกตำแหน่งเเถวที่3คอลัมน์1
    Player 1 คลิกตำแหน่งเเถวที่3คอลัมน์3
    Player 2 คลิกตำแหน่งเเถวที่1คอลัมน์1
    Player 1 คลิกตำแหน่งเเถวที่2คอลัมน์2
    Player 2 คลิกตำแหน่งเเถวที่2คอลัมน์1
...
Player 1 คลิกตำแหน่งเเถวที่1คอลัมน์3
    ...
    Wait Until Element Contain    id=R1_C3    X

Player 2 คลิกตำแหน่งเเถวที่3คอลัมน์1
    Click Element    id=R3_C1
    Wait Until Element Contain    id=R3_C1    O

Player 1 คลิกตำแหน่งเเถวที่3คอลัมน์3
    Click Element    id=R3_C3
    Wait Until Element Contain    id=R3_C3    X
